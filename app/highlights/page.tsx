...
export default function Highlights() {
  ...
  const faqs = [
    {
      question: "What is your approach to technical leadership?",
      answer: "My approach combines hands-on technical expertise with strategic thinking. I focus on mentoring team members, establishing best practices, and ensuring alignment between technical decisions and business goals."
    },
    {
      question: "How do you handle complex system architecture decisions?",
      answer: "I evaluate trade-offs between scalability, maintainability, and performance. I believe in making data-driven decisions while considering both immediate needs and long-term implications."
    },
    {
      question: "What's your experience with microservices architecture?",
      answer: "I have extensive experience designing and implementing microservices architectures, focusing on service boundaries, inter-service communication, and maintaining system resilience."
    },
    {
      question: "How do you approach mentoring junior developers?",
      answer: "I believe in creating a supportive learning environment, providing hands-on guidance, and encouraging independent problem-solving while ensuring code quality and best practices."
    }
  ];
